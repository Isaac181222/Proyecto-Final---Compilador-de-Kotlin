...
std::ostream& operator << ( std::ostream& outs, const Token & tok )
{
    switch (tok.type) {
        ...
        case Token::FLOATNUM: outs << "TOKEN(FLOATNUM)"; break;
        ...
        case Token::TYPEINT: outs << "TOKEN(TYPEINT)"; break;
        case Token::TYPEFLOAT: outs << "TOKEN(TYPEFLOAT)"; break;
        case Token::COLON: outs << "TOKEN(COLON)"; break;
        case Token::LLAVEI: outs << "TOKEN(LLAVEI)"; break;
        case Token::LLAVED: outs << "TOKEN(LLAVED)"; break;
